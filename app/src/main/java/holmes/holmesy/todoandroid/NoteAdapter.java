...
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.TaskViewHolder> {
    ...
    private List<holmes.holmesy.todoandroid.Room.Entity> mTaskEntries;
    ...
    public void onBindViewHolder(TaskViewHolder holder, int position) {
        ...
        holmes.holmesy.todoandroid.Room.Entity taskEntry = mTaskEntries.get(position);
    ...
    public void setTasks(List<Entity> taskEntries) {
